...
And we'll use this pattern here now starting in this shopping cart context file. Because there besides creating and sharing that context, we can also create and share a component function, a CartContextPovider component function. Though the name, of course, as always is up to you, but you, of course, wanna use descriptive component function names.

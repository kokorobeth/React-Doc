...
<details>
<summary>Dynamic & Conditional Styling with Tailwind</summary>

In this case we do midification code on Input.jsx, and rename the function from CustomInput into Input(), also eliminate the css codes.

Change into regular label from <Label and build the tailwind css codes
...
If we see the web after run dev is still broken. 

Or we can modify again like this :
...
<details>
<summary>Migrating the Demo App to Tailwind CSS</summary>

We can go back to file of AuthInputs.jsx file, and first we can delete the css codes of const ControlContainer and also delete the import. And also go back to regular from <ControlContainer into a regular <div .

And here is the complete code of AuthInputs.jsx file 
